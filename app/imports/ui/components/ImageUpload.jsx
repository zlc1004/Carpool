...
import { Button, Form, Message, Segment, Header, Image, Input, Grid, Loader } from 'semantic-ui-react';
        ...
        <Form.Field>
          <Button.Group>
            <Button
              ...
              disabled={!selectedFile || !captchaData || !captchaText.trim() || isUploading}
              loading={isUploading}
            >
              Upload Image
            </Button>
