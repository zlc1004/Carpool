    ...
    return (
      <div className="mobile-forgot-container">
        ...
        <div className="mobile-forgot-content">
          ...
          {!this.state.success ? (
              ...
              <div className="mobile-forgot-input-section">
                ...
                <div className="mobile-forgot-captcha-section">
                  ...
                  <button
                    ...
                    className="mobile-forgot-captcha-refresh"
                  >
                    {this.state.isLoadingCaptcha
                      ? "Loading..."
                      : "Refresh CAPTCHA"}
            ...
            <div className="mobile-forgot-success">
              ...
              <button
                onClick={() =>
                  this.setState({ success: false, email: "", captchaInput: "" })
                }
        ...
        {this.state.showCaptchaErrorModal && (
          <div className="mobile-forgot-modal-overlay">
            <div className="mobile-forgot-modal">
              <div className="mobile-forgot-modal-header">Invalid CAPTCHA</div>
        ...
        <style jsx>{`
          ...
          .mobile-forgot-captcha-refresh:hover {
            background-color: rgba(220, 220, 220, 1);
          }

          .mobile-forgot-captcha-refresh:disabled {
            background-color: rgba(245, 245, 245, 1);
            color: rgba(150, 150, 150, 1);
            cursor: not-allowed;
          }

          .mobile-forgot-modal-overlay {
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
          ...
          .mobile-forgot-modal-actions {
            padding: 0 24px 24px 24px;
            display: flex;
            justify-content: flex-end;
          }

          .mobile-forgot-modal-button {
            background-color: rgba(0, 0, 0, 1);
            color: rgba(255, 255, 255, 1);
            border: none;
            border-radius: 8px;
          ...
          .mobile-forgot-modal-button:hover {
            background-color: rgba(40, 40, 40, 1);
          }
