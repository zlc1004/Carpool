  ...
  "expo": {
    ...
    "plugins": [
      [
        "expo-location",
        {
          "locationAlwaysAndWhenInUsePermission": "Allow CarpSchool to use your location to find nearby carpool routes and track rides for safety.",
      ...
      [
        "expo-image-picker",
        {
          "photosPermission": "The app accesses your photos to let you share them and set profile pictures.",
          "cameraPermission": "The app accesses your camera to let you take photos for your profile and document rides."
        }
      ]
    ],
    "extra": {
